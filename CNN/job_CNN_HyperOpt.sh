...
do
  echo "CNN, fold:" $FOLD
  python CNN/CNN_ModelOptimization.py --fold=$FOLD --device="cuda" --runs=10 --iterations=100
done

# run using: bash CNN/job_CNN_HyperOpt.sh
# or on UBELIX: sbatch CNN/job_CNN_HyperOpt.sh
